...
#ifndef MY_CURRENT_LOCATION_SWIFT_H
#define MY_CURRENT_LOCATION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="My_Current_Location",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC19My_Current_Location11AppDelegate")
...
SWIFT_CLASS("_TtC19My_Current_Location13SceneDelegate")
...
SWIFT_CLASS("_TtC19My_Current_Location14ViewController")
@interface ViewController : UIViewController <CLLocationManagerDelegate>
@property (nonatomic, weak) IBOutlet MKMapView * _Null_unspecified myMap;
- (void)viewDidLoad;
